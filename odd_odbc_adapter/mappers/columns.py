...
def map_column(
        column_metadata: ColumnMetadataNamedtuple, oddrn_generator: OdbcGenerator, owner: str,
) -> DataSetField:
    return DataSetField(
        oddrn=oddrn_generator.get_oddrn_by_path('columns', column_metadata.column_name),
